           ...
           <table class="horizontal">
             ...
             <tbody>
               ...
               <tr>
                 ...
                 <td colspan="7">
                  <label class="w100" style="height:17.2rem;">
                    <textarea placeholder="내용을 입력해주세요." class="w100" style="height:100%"></textarea>\
                  </label>
                  <img src="" alt="" class="mt16"/>
                 </td>
               </tr>
               <tr>
                 ...
                 <td colspan="7" class="left">
                   ...
                   <label for="show" checked style="width:4.5rem; min-width: 4.5rem; display:inline-block;">노출</label>
                   (
